...
export const translations: Record<Language, Translations> = {
  ...
  creditsLabel: 'credits',
    ...
    heroSubtitle: 'Your smart agriculture companion with AI-driven crop recommendations, multilingual support, and marketplace for sustainable farming.',
    ...
    joinThousands: 'Join thousands of farmers who are already using AgriWise to make smarter agricultural decisions.',
  ...
  featureDescCropRecommendations: 'AI-driven crop suggestions based on soil, location, and weather conditions for optimal yield.',
  featureDescChatAssistant: 'Multilingual chat assistant providing real-time agricultural advice and support.',
  featureDescMarketplace: 'Sell your produce and browse items with bidding system for fair pricing.',
  featureDescWeather: 'Timely weather notifications to aid your farming decisions and planning.',
  featureDescCarbonCredits: 'Generate additional income through carbon credit program and sustainable practices.',
  featuresIntro: 'Our comprehensive platform provides all the tools and resources you need to make informed agricultural decisions.',
  benefitsYieldDesc: 'AI-powered recommendations help you choose the best crops for maximum productivity and profitability.',
  benefitsCommunityDesc: 'Connect with fellow farmers and get expert advice through our multilingual chat assistant.',
  benefitsSustainabilityDesc: 'Earn carbon credits while practicing sustainable farming and contributing to environmental protection.',
  ...
  notFoundMessage: 'We couldn\'t find the page you were looking for. Check the URL or return to the homepage.',
  },
  hi: {
    // Header & Navigation
    home: 'होम',
  ...
  enterYourEmail: 'अपना ईमेल दर्ज करें',
    ...
    heroSubtitle: 'आपका स्मार्ट कृषि साथी एआई-संचालित फसल सुझाव, बहुभाषी सहायता और टिकाऊ खेती के लिए बाज़ार के साथ।',
    ...
    joinThousands: 'हजारों किसानों के साथ जुड़ें जो पहले से ही अग्रीवाइज़ का उपयोग कर रहे हैं।',
  ...
  featureDescCropRecommendations: 'मिट्टी, स्थान और मौसम की स्थिति के आधार पर अधिकतम उपज के लिए एआई-संचालित फसल सुझाव।',
  featureDescChatAssistant: 'रियल-टाइम कृषि सलाह और समर्थन प्रदान करने वाला बहुभाषी चैट सहायक।',
  featureDescMarketplace: 'बोली प्रणाली के साथ अपने उत्पाद बेचें और उचित मूल्य सुनिश्चित करने के लिए आइटम ब्राउज़ करें।',
  featureDescWeather: 'आपके कृषि निर्णयों और योजना में मदद करने के लिए समय पर मौसम सूचनाएँ।',
  featureDescCarbonCredits: 'टिकाऊ प्रथाओं के माध्यम से अतिरिक्त आय उत्पन्न करें और कार्बन क्रेडिट प्रोग्राम में भाग लें।',
  featuresIntro: 'हमारा समग्र प्लेटफ़ॉर्म आपको सूचित कृषि निर्णय लेने के लिए सभी उपकरण और संसाधन प्रदान करता है।',
  benefitsYieldDesc: 'एआई-संचालित सिफारिशें आपको अधिकतम उत्पादकता और लाभ के लिए सबसे अच्छी फसल चुनने में मदद करती हैं।',
  benefitsCommunityDesc: 'अन्य किसानों से जुड़ें और हमारे बहुभाषी चैट सहायक के माध्यम से विशेषज्ञ सलाह प्राप्त करें।',
  benefitsSustainabilityDesc: 'टिकाऊ खेती का अभ्यास करते हुए कार्बन क्रेडिट कमाएँ और पर्यावरण संरक्षण में योगदान दें।',
  mobileAvailability: 'अंग्रेज़ी, हिंदी और मलयालम में उपलब्ध',
  // Error pages
  errorTitle: 'कुछ गलत हो गया',
  errorMessage: 'एक अनपेक्षित त्रुटि हुई। कृपया पुनः प्रयास करें या समस्या बनी रहने पर समर्थन से संपर्क करें।',
  retry: 'पुनः प्रयास',
  goHome: 'होम पर जाएँ',
  notFoundTitle: 'पृष्ठ नहीं मिला',
  notFoundMessage: 'हम जिस पृष्ठ की आप तलाश कर रहे थे वह नहीं मिला। URL जांचें या होमपेज पर लौटें।',
  },
  ml: {
    // Header & Navigation
    home: 'ഹോം',
  ...
  creditMarketPrice: 'വിപണി വില',
    ...
    heroSubtitle: 'AI-ചാലിത വിള ശുപാർശകൾ, ബഹുഭാഷാ പിന്തുണ, സുസ്ഥിര കൃഷിക്കുള്ള മാർക്കറ്റ്പ്ലേസ് എന്നിവയുള്ള നിങ്ങളുടെ സ്മാർട്ട് കൃഷി കൂട്ടാളി.',
  ...
  featureDescCropRecommendations: 'മണ്ണ്, സ്ഥലം, കാലാവസ്ഥാ അനുസരിച്ച് ബെസ്റ്റ് വിളകൾ തെരഞ്ഞെടുക്കാൻ AI-ചാലിത ശുപാർശകൾ.',
  featureDescChatAssistant: 'തൽക്ഷണ ഫാർമിംഗ് ഉപദേശം നൽകുന്ന ബഹുഭാഷാ ചാറ്റ് അസിസ്റ്റന്റ്.',
  featureDescMarketplace: 'നീങ്ങളുടെ ഉൽപ്പന്നങ്ങൾ വിൽക്കുക, ന്യായമായ വിലക്കായി ബിഡിംഗ് സംവിധാനത്തോടെ ഇനങ്ങൾ ബ്രൗസ് ചെയ്യുക.',
  featureDescWeather: 'നിങ്ങളുടെ കൃഷി തീരുമാനങ്ങളിൽ സഹായിക്കുന്ന സമയോചിത കാലാവസ്ഥാ അറിയിപ്പുകൾ.',
  featureDescCarbonCredits: 'സുസ്ഥിര രീതികൾ വഴി അധിക വരുമാനം ഉണ്ടാക്കൂ; കാർബൺ ക്രെഡിറ്റ് പ്രോഗ്രാമിൽ പങ്കാളിയാവൂ.',
  featuresIntro: 'നിങ്ങൾക്ക് അറിവുള്ള കൃഷി തീരുമാനങ്ങൾ സംഘടിപ്പിക്കാൻ ഞങ്ങളുടെ സമഗ്ര പ്ലാറ്റ്ഫോം എല്ലാ ഉപകരണങ്ങളും വിഭവങ്ങളും ലഭ്യമാക്കുന്നു.',
  benefitsYieldDesc: 'AI-ചാലിത ശുപാർശകൾ നിങ്ങൾക്ക് പരമാവധി ഉൽപ്പാദനക്ഷമതയ്‌ക്കും ലാഭത്തിനും അനുയോജ്യമായ വിളകൾ തിരഞ്ഞെടുക്കാൻ സഹായിക്കുന്നു.',
  benefitsCommunityDesc: 'ഒപ്പം കർഷകരുമായി ബന്ധപ്പെടുക, ബഹുഭാഷാ ചാറ്റ് അസിസ്റ്റന്റെ വഴി വിദഗ്ധ സഹായം നേടുക.',
  benefitsSustainabilityDesc: 'സുസ്ഥിര കൃഷി പ്രയോഗങ്ങൾ വഴി കാർബൺ ക്രെഡിറ്റുകൾ സമ്പാദിക്കുക; പരിസ്ഥിതിക്ക് സംഭാവന നൽകുക.',
  mobileAvailability: 'ഇംഗ്ലീഷ്, ഹിന്ദി & മലയാളത്തിൽ ലഭ്യമാണ്',
  // Error pages
  errorTitle: 'എന്തോ തെറ്റ് സംഭവിച്ചു',
  errorMessage: 'ഒരു അനपेക്ഷിത പിശക് സംഭവിച്ചു. ദയവായി വീണ്ടും ശ്രമിക്കുക അല്ലെങ്കിൽ പ്രശ്നം തുടർന്നാൽ പിന്തുണയുമായി ബന്ധപ്പെടുക.',
  retry: 'മറുപടി ശ്രമിക്കുക',
  goHome: 'ഹോംൽ പോകുക',
  notFoundTitle: 'പേജ് കണ്ടെത്തിയില്ല',
  notFoundMessage: 'നിങ്ങൾ അന്വേഷിച്ച പേജ് കണ്ടെത്താനായില്ല. URL പരിശോധിക്കുക അല്ലെങ്കിൽ ഹോംപേജിലേക്ക് മടങ്ങുക.',
  },
}
