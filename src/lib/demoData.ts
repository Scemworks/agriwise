...
export const demoData = {
  ...
  cropRecommendations: [
    ...
    },
    {
      ...
      disadvantages: ["Long gestation period", "Requires regular maintenance"],
  ...
  marketplaceProducts: [
    {
      ...
      quantity: "50 kg",
      description:
        "Premium quality organic basmati rice, freshly harvested. No pesticides used.",
      category: "Grains",
      isAuction: false,
      condition: "Fresh",
    ...
    },
    {
      ...
      quantity: "1 dozen",
      description:
        "Sweet and juicy Alphonso mangoes, perfect for eating or making desserts.",
      category: "Fruits",
      isAuction: true,
    ...
    },
    {
      ...
      quantity: "1 unit",
      description:
        "Well-maintained tractor, 2 years old. Perfect for small to medium farms.",
      category: "Equipment",
      isAuction: true,
    ...
    },
    {
      ...
      quantity: "1 liter",
      description:
        "Fresh buffalo milk, collected daily. Rich in nutrients and protein.",
      category: "Livestock",
      isAuction: false,
      condition: "Fresh",
      image: "/api/placeholder/300/200",
  ...
  sustainablePractices: [
    ...
    },
    {
      ...
      creditsPerAcre: 0.4,
      implementation:
        "Plant cover crops like legumes or grasses between main crops",
      benefits: [
