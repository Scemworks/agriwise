...
class Logger {
  ...
  error(
    ...
    this.writeLog(
      this.createLogEntry(LogLevel.ERROR, message, context, request),
    );
  }
  ...
  warn(
    ...
    this.writeLog(
      this.createLogEntry(LogLevel.WARN, message, context, request),
    );
  }
  ...
  info(
    ...
    this.writeLog(
      this.createLogEntry(LogLevel.INFO, message, context, request),
    );
  }
  ...
  debug(
    ...
    this.writeLog(
      this.createLogEntry(LogLevel.DEBUG, message, context, request),
    );
  }
