...
import { CheckCircle, Info, Sprout, XCircle } from "lucide-react";
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription className="text-muted">
                  Provide your farming details to get personalized
                  recommendations
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="rainfall" className="text-gray-700">
                        Rainfall (mm)
                      </Label>
                      <Input
                        id="rainfall"
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor="phLevel" className="text-gray-700">
                        Soil pH Level
                      </Label>
                      <Input
                        id="phLevel"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="elevation" className="text-gray-700">
                        Elevation (meters)
                      </Label>
                      <Input
                        id="elevation"
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor="organicMatter" className="text-gray-700">
                        Organic Matter (%)
                      </Label>
                      <Input
                        id="organicMatter"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="sunlight" className="text-gray-700">
                        Sunlight Hours/Day
                      </Label>
                      <Input
                        id="sunlight"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="moisture" className="text-gray-700">
                      Soil Moisture (%)
                    </Label>
                    <Input
                      id="moisture"
                      ...
                      >
                        <CardHeader>
                          <div className="flex items-center justify-between">
                            ...
                            <div
                              className={`px-3 py-1 rounded-full text-sm font-medium ${getSuitabilityColor(crop.suitability)}`}
                            >
                              {crop.suitability}% Match
                            </div>
                          </div>
                          <CardDescription className="text-muted">
                            Expected yield: {crop.expectedYield} | Market price:{" "}
                            {crop.marketPrice}
                        ...
                        <CardContent>
                          <div className="space-y-4">
                            ...
                            <div>
                              ...
                              <ul className="space-y-1">
                                {crop.disadvantages.map(
                                  (disadvantage: string, idx: number) => (
                                    <li
                                      key={idx}
                                      className="text-sm text-muted flex items-start"
                                    >
