      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p
              className={`text-xl text-muted max-w-2xl mx-auto ${isChatting ? "hidden sm:block" : ""}`}
            >
              Ask me anything about farming, crops, weather, market prices, or
              sustainable agriculture practices. I'm here to help!
            </p>
          </div>
                ...
                <CardContent className="flex-1 flex flex-col min-h-0">
                  ...
                  <div className="flex-1 overflow-y-auto space-y-4 mb-4 pr-2 min-h-0 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent pb-24 sm:pb-6">
                    {messages.map((message) => (
                      ...
                      >
                        <div
                          className={`max-w-[80%] max-w-full rounded-lg p-3 break-words whitespace-pre-wrap ${
                            message.sender === "user"
                  ...
                  <div className="flex flex-col sm:flex-row sm:space-x-2 space-y-2 sm:space-y-0 z-10 bg-transparent">
                    <div className="flex-1 relative">
                      <Input
                        ...
                        onBlur={() => {
                          /* keep chatting state until user navigates away */
                        }}
