...
function _weatherCodeToCondition(code: number) {
...
export default function WeatherPage() {
  ...
  // Mock weather data
  const _mockWeatherData: WeatherData = {
  ...
  const _mockForecast: ForecastDay[] = [
    {
      date: "2024-01-15",
      high: 32,
      low: 24,
  ...
  const _mockAlerts: WeatherAlert[] = [
    ...
    },
    {
      ...
      description:
        "Current weather conditions are ideal for planting rice and vegetables.",
      time: "1 day ago",
    },
    {
      id: "3",
      ...
      description:
        "Perfect weather for harvesting your current crops. Low humidity and clear skies.",
      time: "3 days ago",
    },
  ];
  ...
  const fetchForLocation = async (q: string) => {
    ...
    try {
      ...
      if (!res.ok || !json.city) {
        ...
        res = await fetch(
          `/api/weather/global/weather?location=${encodeURIComponent(q)}&days=3`,
        );
        json = await res.json();
      ...
      if (isIndianWeather) {
        ...
        else if (current.temperature?.max?.value != null)
          temperature = current.temperature.max.value;
        else if (current.temperature?.min?.value != null)
          temperature = current.temperature.min.value;
        ...
        if (typeof current.humidity === "number") humidity = current.humidity;
          ...
          const vals = Object.values(current.humidity).filter(
            (v: any) => typeof v === "number",
          ) as number[];
          humidity = vals.length
        ...
        const windDirection =
          current.wind_direction ?? current.windDirection ?? null;
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Stay informed about weather conditions to make better farming
              decisions
            </p>
          </div>
          ...
          <div className="mb-8">
                ...
                <Input
                  ...
                  onFocus={() =>
                    setShowCitySuggestions(
                      location.length > 2 && filteredCities.length > 0,
                    )
                  }
            ...
            <div className="text-center mt-2">
              <p className="text-sm text-gray-500">
                Try Indian cities like Chennai, Delhi, Mumbai, Bangalore, or
                global locations
              </p>
            </div>
          </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {forecast.map((day, index) => (
                      <div
                        key={index}
                        className="flex flex-col sm:flex-row items-center sm:justify-between p-4 bg-gray-50 rounded-lg"
                      >
                  ...
                  <div className="space-y-3">
                    <div className="p-3 bg-green-50 rounded-lg">
                      ...
                      <p className="text-xs text-green-700">
                        Water your crops in the early morning or evening to
                        reduce evaporation.
                      </p>
                    </div>
                    ...
                    <div className="p-3 bg-blue-50 rounded-lg">
                      ...
                      <p className="text-xs text-blue-700">
                        High humidity conditions may increase pest activity.
                        Monitor your crops closely.
                      </p>
                    </div>
                    ...
                    <div className="p-3 bg-yellow-50 rounded-lg">
                      ...
                      <p className="text-xs text-yellow-700">
                        Clear weather expected in 2 days - ideal for harvesting
                        activities.
                      </p>
                    </div>
                  </div>
