      ...
      .then((data) => {
        ...
        if (data?.products) {
          ...
          const mapped = data.products.map((p: any) => ({
            ...
            isAuction: (p.listings || []).some((l: any) => l.type === 'auction'),
            timeLeft: undefined,
            bids: (p.listings || []).reduce((acc: number, l: any) => acc + (l.bids?.length || 0), 0),
  ...
  <p className="text-sm text-muted mb-3 line-clamp-2">{product.description}</p>
        ...
        {product.isAuction && (
            <div className="flex items-center justify-between mb-3 text-sm">
              <span className="text-orange-600 font-medium">{product.timeLeft}</span>
        ...
        <form className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input id="productName" placeholder="Enter product name" className='text-muted' />
            </div>
            <div className="space-y-2">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <Input id="price" type="number" placeholder="Enter price" className='text-muted' />
            </div>
            <div className="space-y-2">
              <Label htmlFor="quantity" className='text-gray-700'>Quantity</Label>
              <Input id="quantity" placeholder="e.g., 50 kg" className='text-muted' />
            </div>
            <div className="space-y-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="auction" className='text-gray-700'>{t.auction}</Label>
          </div>
            ...
            <>
              ...
              <div className="mb-8">
                <div className="flex flex-col md:flex-row gap-4 mb-4">
                  ...
                  <Button variant="outline" className='text-gray-600 border-green-500'>
