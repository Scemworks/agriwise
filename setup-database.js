...
async function setupDatabase() {
  ...
  try {
    ...
    execSync('npx prisma migrate dev --name add_location_and_ai_features', { stdio: 'inherit' })
    ...
    console.log('2. Get your Indian Weather API key from http://indianapi.in/weather-api')
